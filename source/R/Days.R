...
waiting20 = read.csv("results/days/20_Days1_waitingTimes.csv", header = TRUE)
waiting30 = read.csv("results/days/30_Days1_waitingTimes.csv", header = TRUE)
waiting40 = read.csv("results/days/40_Days1_waitingTimes.csv", header = TRUE)
waiting50 = read.csv("results/days/50_Days1_waitingTimes.csv", header = TRUE)
waiting60 = read.csv("results/days/60_Days1_waitingTimes.csv", header = TRUE)
waiting70 = read.csv("results/days/70_Days1_waitingTimes.csv", header = TRUE)
...
for (i in 1:length(timepoints)) {
  ...
  if (sum(waiting60$X0 == timepoints[i]) > 0) {
    mergedData$w60[i] = waiting20$X[waiting60$X0 == timepoints[i]]
  }
