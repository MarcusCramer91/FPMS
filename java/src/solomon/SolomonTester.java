	...
	public static void main(String[] args) throws IOException {
		...
		for (String solomonPath : solomonProblems) {
			...
			for (int nCustomers : problemSizes) {
				...
				int nVehicles = 20;
				if (solomonPath.equals("C:\\Users\\Marcus\\Documents\\FPMS\\Solomon test instances\\r101.txt")) nVehicles = 19;
				if (solomonPath.equals("C:\\Users\\Marcus\\Documents\\FPMS\\Solomon test instances\\r102.txt")) nVehicles = 17;
				if (solomonPath.equals("C:\\Users\\Marcus\\Documents\\FPMS\\Solomon test instances\\r103.txt")) nVehicles = 13;
				if (solomonPath.equals("C:\\Users\\Marcus\\Documents\\FPMS\\Solomon test instances\\r104.txt")) nVehicles = 9;
				if (solomonPath.equals("C:\\Users\\Marcus\\Documents\\FPMS\\Solomon test instances\\r105.txt")) nVehicles = 14;
				if (solomonPath.equals("C:\\Users\\Marcus\\Documents\\FPMS\\Solomon test instances\\r106.txt")) nVehicles = 12;
				if (solomonPath.equals("C:\\Users\\Marcus\\Documents\\FPMS\\Solomon test instances\\r107.txt")) nVehicles = 10;
				if (solomonPath.equals("C:\\Users\\Marcus\\Documents\\FPMS\\Solomon test instances\\r108.txt")) nVehicles = 9;
				if (solomonPath.equals("C:\\Users\\Marcus\\Documents\\FPMS\\Solomon test instances\\r109.txt")) nVehicles = 11;
				...
				ArrayList<ArrayList<Integer>> routes = CPlexConnector.getRoutesSolomon(distanceMatrix, orders, vehicles, 30, capacity,
						compTimeLimit, true, problemInstance);
