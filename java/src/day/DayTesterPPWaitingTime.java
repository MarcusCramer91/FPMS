...
public class DayTesterPPWaitingTime {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < waitingTimes.length; i++) {
			...
			try {
				DayTesterPPWaitingTime tester = new DayTesterPPWaitingTime(distmat, orders);
	...
	public DayTesterPPWaitingTime(DistanceMatrix distmat, ArrayList<Order> orders) {
