...
public class DayTesterFPRouteLengthGoodness {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int minimumRouteLength : minimumRouteLengths) {
			...
			try {
				DayTesterFPRouteLengthGoodness tester = new DayTesterFPRouteLengthGoodness(distmat, orders);
	...
	public DayTesterFPRouteLengthGoodness(DistanceMatrix distmat, ArrayList<Order> orders) {
