...
public class DayTesterFPMETGoodness {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int metThreshold : metThresholds) {
			...
			try {
				DayTesterFPMETGoodness tester = new DayTesterFPMETGoodness(distmat, orders);
	...
	public DayTesterFPMETGoodness(DistanceMatrix distmat, ArrayList<Order> orders) {
