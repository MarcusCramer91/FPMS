...
public class DayTesterFPExceedingsLogged {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < waitingTimes.length; i++) {
			...
			int endTime = 43200; // 9 pm
				...
				DayTesterFPExceedingsLogged tester = new DayTesterFPExceedingsLogged(distmat, orders);
				tester.getFlaschenPostCosts(startingTime, endTime, waitingTimes[i]);
		}
	}
	
	public DayTesterFPExceedingsLogged(DistanceMatrix distmat, ArrayList<Order> orders) {
