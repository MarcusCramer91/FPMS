 ...
 *
 */
public class ESPPTWCC_Heuristic2 {
	...
	public static void main(String[] args) throws IOException {
		...
		// initialize graph structure
		 ...
		 ESPPTWCC_Heuristic2 spptwcc = new ESPPTWCC_Heuristic2(distmat, reducedCostsMat, orders, 40*60, 50, true);
		 spptwcc.labelNodes();
	}
	
	public ESPPTWCC_Heuristic2(DistanceMatrix distmat, DistanceMatrix reducedCostsMat, ArrayList<Order> orders, int currentTime,
